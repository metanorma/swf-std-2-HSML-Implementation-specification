...
| <<w3c-verifiable-credential,w3c:VerifiableCredential>>
...
| A reusable, core entity that explicitly models the involvement of an entity in a specific role within a given context, such as a contract.
|===
