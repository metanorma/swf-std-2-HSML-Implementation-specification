...
| <<core-entity-property-type,rdf:type>> | `@type` | Declares the resource as an instance of `comm:Channel`. | 1..n
| <<core-entity-property-swid,core:swid>> | `swid` | The Spatial Web Identifier (SWID) inherited from `core:Entity`. | 1
