...
[[hsml-atomic_activity_schema-class]]
...
.act:AtomicActivitySchema Definition
[cols="1,4",options="header"]
|===
|Attribute |Value
...
[[hsml-composite_activity_schema-class]]
...
.act:CompositeActivitySchema Definition
[cols="1,4",options="header"]
|===
|Attribute |Value
