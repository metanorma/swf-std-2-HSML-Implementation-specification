...
include::activity_module_principles.adoc[leveloffset=+1]
...
The namespace prefix `act:` refers to identifier:[https://www.spatialwebfoundation.org/ns/hsml/activity#].
...
include::hsml_activity.adoc[leveloffset=+1]

include::hsml_activity_schema.adoc[leveloffset=+1]

include::hsml_atomic_activity_schema.adoc[leveloffset=+1]

include::hsml_composite_activity_schema.adoc[leveloffset=+1]

include::hsml_activity_step.adoc[leveloffset=+1]

include::hsml_data_link.adoc[leveloffset=+1]

include::hsml_variable.adoc[leveloffset=+1]

include::hsml_variable_binding.adoc[leveloffset=+1]
